                ...
                <div className="w-full min-h-60 card text-xl bg-base-100 relative font-bold">
                    ...
                    <Card className="w-full h-full card border-none text-xl bg-base-100 relative font-bold">
                        <CardHeader className="text-white">
                            <Skeleton className="flex absolute right-4 w-[250px] h-7" />
                            <CardTitle className="text-3xl ">Now</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <CardDescription className="flex items-center justify-between">
                                <Skeleton className="text-white text-6xl font-bold  h-16 w-[250px]" />
                                <Skeleton className="text-white text-6xl font-bold  h-16 w-36" />
                            </CardDescription>
                        </CardContent>
